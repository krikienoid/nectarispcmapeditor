...
void EditorMain::loadSelectedMapData(const std::size_t i) {
    Nec::MapInfo* const necMapInfo = &(necData->bigInfo->at(i));
    Nec::MapMap* const necMapMap = &(necData->bigMap->at(i));
